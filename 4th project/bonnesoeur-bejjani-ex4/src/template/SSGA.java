...
public class SSGA{
	...
	public Coordination generatePlan(List<Vehicle> vehicles, ArrayList<Task> tasks, Random random) 
    {
		...
		System.out.println("we had a initial cost of "+ new Coordination(vehicles,tasks,rand).getTotalCost());

		
		for(int i=0;i<populationSize;i++)
		{
			Coordination ind = new Coordination(vehicles,tasks,rand);
