...
public class CentralizedTemplate implements CentralizedBehavior {
    ...
    private List<Plan> stockasticLocalSearch(List<Vehicle> vehicles, TaskSet tasks) {
        ...
        coord.printCoord();
        Coordination mut1 = coord.mutate();
        System.out.println("We mutated");
        mut1.printCoord();
        System.out.println("we had a initial cost of "+coord.getTotalCost()+" and a final cost of "+mut1.getTotalCost());
    	List<Plan> plan = mut1.getPlans();
    ...
    private class Coordination{
    		...
    		public Coordination mutate() {
    			...
    			System.out.println("Total cost before mutation" + this.getTotalCost());
    			//this.printCoord();
    			System.out.println("Total cost of the mutation before" + mut1.getTotalCost());

    			mut1.changeSeqVehicle();
    			mut1.changeGroupSequence();
    			mut1.sequences.get(vehicles.get(0)).changeGroupOrder();
    			
    			mut1.sequences.get(vehicles.get(0)).changeTaskGroup();
    ...
    private class Sequence{
	    	...
	    	public void changeTaskGroup() {
	    		if(groups.size()>1 && getSeqEvents()!=null)
	    		{
