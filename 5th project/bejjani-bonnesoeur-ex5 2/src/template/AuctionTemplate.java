...
public class AuctionTemplate implements AuctionBehavior {
	...
	public void setup(Topology topology, TaskDistribution distribution, Agent agent) {
        ...
        timeout_bid = 1000;//ls.get(LogistSettings.TimeoutKey.BID);
        // the plan method cannot execute more than timeout_plan milliseconds
        timeout_plan = 1000;//ls.get(LogistSettings.TimeoutKey.PLAN);
	}
...
//		cost /= myTaskList.size();
        ...
        System.out.println("The bid was generated in "+duration+" milliseconds and the timeout is :" + timeout_bid);
...
//			return task.reward;
	...
	public List<Plan> plan(List<Vehicle> vehicles, TaskSet tasks) {
		...
		Coordination Xcoord = new Coordination(alg.generateCoord(vehicles, wonTaskList, mySeed, populationSize, (long) Math.round(0.95*timeout_plan)));
		...
		long time_end = System.currentTimeMillis();
        long duration = time_end - time_start;
        System.out.println("The plan was generated in "+duration+" milliseconds and the timeout is :" + timeout_plan);
